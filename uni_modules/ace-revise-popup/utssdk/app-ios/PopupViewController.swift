...
class PopupViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate   {
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
            ...
            remarkLabel.leadingAnchor.constraint(equalTo: containerView.leadingAnchor, constant: 20),
            remarkLabel.trailingAnchor.constraint(equalTo: containerView.trailingAnchor, constant: -20)
        ])
